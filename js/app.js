(() => {
    ...
    function initSliders() {
        if (document.querySelector(".income__slider")) new core(".income__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".income__slider .swiper-button-prev",
                nextEl: ".income__slider .swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".present__slider")) new core(".present__slider", {
            modules: [ Navigation, Pagination, EffectCoverflow, Parallax ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            spaceBetween: 20,
            ...
            navigation: {
                prevEl: ".present__slider .swiper-button-prev",
                nextEl: ".present__slider .swiper-button-next"
            },
            on: {}
        });
    }
    ...
    function documentActions() {
        ...
        const search = document.querySelector(".actions-header__search");
        document.addEventListener("click", menu);
        function menu(event) {
            if (event.target.closest(".search-header__icon")) search.classList.toggle("_open");
            if (!event.target.closest(".actions-header__search")) search.classList.remove("_open");
        }
        const cart = document.querySelector(".actions-header__cart");
        const cartValue = document.querySelector(".actions-header__cart span");
        const speedAnimation = 1e3;
        document.addEventListener("click", (function(e) {
            const targetElement = e.target;
            if (targetElement.closest(".slide-income__cart")) {
                const productSlide = targetElement.closest(".income__slide");
                const productImage = productSlide.querySelector(".slide-income__image");
        ...
        let favorites = document.querySelectorAll(".slide-income__body");
        if (favorites.length > 0) for (let index = 0; index < favorites.length; index++) {
            const favorite = favorites[index];
            favorite.addEventListener("click", (function(e) {
                favorite.parentElement.classList.toggle("_active");
            }));
        }
        let social = document.querySelectorAll(".instagram__item");
        social.forEach((social => {
            social.addEventListener("click", (function(e) {
                social.classList.toggle("_open");
                if (!target.closest(".instagram__item")) social.classList.remove("_open");
            }));
        }));
